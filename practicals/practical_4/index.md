...
> Set your DC power supply to approximately 9.8V, and connect it to the input to the voltage regulator you built in Question 1. You should see an output of 3.3V. If you do not, adjust your potentiometer until you get very close. When you are satisfied, connect the ground pin of your STM32 to the ground of your circuit, and the 3.3V pin to the regulated 3.3V output. You should see the screen light up with whatever code you last ran on your development board. If this is working, your circuit is functioning as intended.
